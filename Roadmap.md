...
- Дополнить профиль по референсу RZT: сделать более насыщенную левую колонку с аватаром, описанием, социальными ссылками, уровнем профиля и краткой статистикой.
- Добавить разделы внутри профиля: предпочтения, рецензии и оценки, понравившееся, достижения.
- Для раздела рецензий предусмотреть фильтры: все рецензии, рецензии с авторскими лайками, оценки без текстовой рецензии.
- Продумать визуальный баннер профиля: обложка, затемнение, корректное поведение в светлой и темной темах.

### Уровень и статистика

- Разработать понятную систему уровня пользователя: баллы сообщества, сезонный уровень, место в топе и прогресс до следующего уровня.
- Вывести статистику профиля отдельным блоком: количество рецензий, оценок без рецензий, полученных лайков, поставленных лайков, авторских лайков.
- Подумать над сезонной статистикой и общей статистикой за все время.
- Добавить достижения/бейджи за активность, жанровое разнообразие, качество рецензий и реакции сообщества.

### Дизайн и темы

- Усилить общий визуальный уровень интерфейса: меньше ощущения учебного макета, больше цельной продуктовой системы.
- Пересмотреть светлую тему: сохранить приятные теплые оттенки, но сделать контраст, тени, бордеры и поверхности дороже и аккуратнее.
- Унифицировать кнопки, иконки, бейджи, карточки и состояния hover/focus во всех ключевых местах.
- Проверить темную и светлую темы на страницах ленты, топов, профиля, альбома, трека и поиска.
